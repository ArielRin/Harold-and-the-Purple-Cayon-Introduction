...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t, e) {
      ...
      "use strict";
      var t = 1e3, e = 6e4, n2 = 36e5, r = "millisecond", i2 = "second", s2 = "minute", u = "hour", a2 = "day", o = "week", c2 = "month", f2 = "quarter", h2 = "year", d4 = "date", l2 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y2 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t2) {
        ...
        return { M: c2, y: h2, w: o, d: a2, D: d4, h: u, m: s2, s: i2, ms: r, Q: f2 }[t2] || String(t2 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t2) {
        return void 0 === t2;
      } }, g2 = "en", D = {};
      D[g2] = M;
      var p3 = "$isDayjsObject", S2 = function(t2) {
        return t2 instanceof _2 || !(!t2 || !t2[p3]);
      }, w3 = function t2(e2, n3, r2) {
        var i3;
        if (!e2) return g2;
        if ("string" == typeof e2) {
      ...
      b2.l = w3, b2.i = S2, b2.w = function(t2, e2) {
        return O2(t2, { locale: e2.$L, utc: e2.$u, x: e2.$x, $offset: e2.$offset });
      };
      var _2 = function() {
        function M2(t2) {
          this.$L = w3(t2.locale, null, true), this.parse(t2), this.$x = this.$x || t2.x || {}, this[p3] = true;
        }
        var m3 = M2.prototype;
        return m3.parse = function(t2) {
          ...
          var n3, o2 = b2.p(t2), f3 = "set" + (this.$u ? "UTC" : ""), l3 = (n3 = {}, n3[a2] = f3 + "Date", n3[d4] = f3 + "Date", n3[c2] = f3 + "Month", n3[h2] = f3 + "FullYear", n3[u] = f3 + "Hours", n3[s2] = f3 + "Minutes", n3[i2] = f3 + "Seconds", n3[r] = f3 + "Milliseconds", n3)[o2], $2 = o2 === a2 ? this.$D + (e2 - this.$W) : e2;
          if (o2 === c2 || o2 === h2) {
            var y3 = this.clone().set(d4, 1);
            y3.$d[l3]($2), y3.init(), this.$d = y3.set(d4, Math.min(this.$D, y3.daysInMonth())).$d;
          } else l3 && this.$d[l3]($2);
          ...
          if ($2 === a2) return y3(1);
          if ($2 === o) return y3(7);
          var M3 = (d5 = {}, d5[s2] = e, d5[u] = n2, d5[i2] = t, d5)[$2] || 1, m4 = this.$d.getTime() + r2 * M3;
          return b2.w(m4, this);
        ...
        }, m3.diff = function(r2, d5, l3) {
          var $2, y3 = this, M3 = b2.p(d5), m4 = O2(r2), v3 = (m4.utcOffset() - this.utcOffset()) * e, g3 = this - m4, D2 = function() {
            return b2.m(y3, m4);
          };
          switch (M3) {
            case h2:
          ...
          if (!t2) return this.$L;
          var n3 = this.clone(), r2 = w3(t2, e2, true);
      ...
      return O2.prototype = k2, [["$ms", r], ["$s", i2], ["$m", s2], ["$H", u], ["$W", a2], ["$M", c2], ["$y", h2], ["$D", d4]].forEach(function(t2) {
        k2[t2[1]] = function(e2) {
          return this.$g(e2, t2[0], t2[1]);
        };
      }), O2.extend = function(t2, e2) {
        return t2.$i || (t2(e2, _2, O2), t2.$i = true), O2;
      }, O2.locale = w3, O2.isDayjs = S2, O2.unix = function(t2) {
        return O2(1e3 * t2);
  ...
  "node_modules/dayjs/plugin/relativeTime.js"(exports, module) {
    !function(r, e) {
      ...
      return function(r, e, t) {
        ...
        t.en.relativeTime = o, n2.fromToBase = function(e2, n3, i3, d5, u) {
          for (var f2, a2, s2, l2 = i3.$locale().relativeTime || o, h2 = r.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m2 = h2.length, c2 = 0; c2 < m2; c2 += 1) {
            var y2 = h2[c2];
            y2.d && (f2 = d5 ? t(e2).diff(i3, y2.d, true) : i3.diff(e2, y2.d, true));
            var p3 = (r.rounding || Math.round)(Math.abs(f2));
            if (s2 = f2 > 0, p3 <= y2.r || !y2.r) {
              p3 <= 1 && c2 > 0 && (y2 = h2[c2 - 1]);
              var v2 = l2[y2.l];
              u && (p3 = u("" + p3)), a2 = "string" == typeof v2 ? v2.replace("%d", p3) : v2(p3, n3, y2.l, s2);
              break;
            }
          }
          if (n3) return a2;
        ...
        n2.toNow = function(r2) {
          return this.to(d4(this), r2);
        }, n2.fromNow = function(r2) {
          return this.from(d4(this), r2);
        };
      };
    });
  }
...
var require_ieee754 = __commonJS({
  "node_modules/ieee754/index.js"(exports) {
    exports.read = function(buffer, offset, isLE, mLen, nBytes) {
      ...
      s2 >>= -nBits;
      nBits += eLen;
      for (; nBits > 0; e = e * 256 + buffer[offset + i2], i2 += d4, nBits -= 8) {
      }
      m2 = e & (1 << -nBits) - 1;
      e >>= -nBits;
      nBits += mLen;
      for (; nBits > 0; m2 = m2 * 256 + buffer[offset + i2], i2 += d4, nBits -= 8) {
      }
      if (e === 0) {
        e = 1 - eBias;
      } else if (e === eMax) {
    ...
    exports.write = function(buffer, value, offset, isLE, mLen, nBytes) {
      ...
      for (; mLen >= 8; buffer[offset + i2] = m2 & 255, i2 += d4, m2 /= 256, mLen -= 8) {
      }
      e = e << mLen | m2;
      eLen += mLen;
      for (; eLen > 0; buffer[offset + i2] = e & 255, i2 += d4, e /= 256, eLen -= 8) {
      }
      buffer[offset + i2 - d4] |= s2 * 128;
    };
  }
});
...
var require_browser2 = __commonJS({
  "node_modules/pino/browser.js"(exports, module) {
    ...
    function set(opts, logger, level, fallback) {
      ...
      wrap4(opts, logger, level);
    }
    function wrap4(opts, logger, level) {
...
var ReactiveElement = class extends HTMLElement {
  ...
  __initialize() {
    ...
    this.requestUpdate();
    (_a8 = this.constructor._initializers) == null ? void 0 : _a8.forEach((i2) => i2(this));
  }
  /**
  ...
  connectedCallback() {
    ...
    (_a8 = this.__controllers) == null ? void 0 : _a8.forEach((c2) => {
      var _a9;
      return (_a9 = c2.hostConnected) == null ? void 0 : _a9.call(c2);
    });
  }
  /**
  ...
  disconnectedCallback() {
    ...
    (_a8 = this.__controllers) == null ? void 0 : _a8.forEach((c2) => {
      var _a9;
      return (_a9 = c2.hostDisconnected) == null ? void 0 : _a9.call(c2);
    });
  }
  /**
  ...
  performUpdate() {
    ...
    try {
      ...
      if (shouldUpdate) {
        ...
        (_a8 = this.__controllers) == null ? void 0 : _a8.forEach((c2) => {
          var _a9;
          return (_a9 = c2.hostUpdate) == null ? void 0 : _a9.call(c2);
        });
  ...
  _$didUpdate(changedProperties) {
    ...
    (_a8 = this.__controllers) == null ? void 0 : _a8.forEach((c2) => {
      var _a9;
      return (_a9 = c2.hostUpdated) == null ? void 0 : _a9.call(c2);
    });
    if (!this.hasUpdated) {
...
var getTemplateHtml = (strings, type) => {
  ...
  const htmlResult = html3 + (strings[l2] || "<?>") + (type === SVG_RESULT ? "</svg>" : "");
      ...
      if (node.nodeType === 1) {
        if (DEV_MODE2) {
          ...
          if (/^(?:textarea|template)$/i.test(tag3) && node.innerHTML.includes(marker)) {
            const m2 = `Expressions are not supported inside \`${tag3}\` elements. See https://lit.dev/msg/expression-in-${tag3} for more information.`;
            if (tag3 === "template") {
              throw new Error(m2);
            } else
              issueWarning2("", m2);
...
function resolveDirective(part, value, parent2 = part, attributeIndex) {
  ...
  let currentDirective = attributeIndex !== void 0 ? (_a8 = parent2.__directives) == null ? void 0 : _a8[attributeIndex] : parent2.__directive;
...
var ChildPart = class _ChildPart {
  ...
  _$setValue(value, directiveParent = this) {
    ...
    if (isPrimitive(value)) {
      ...
      if (DEV_MODE2 && ((_a8 = this.options) == null ? void 0 : _a8.host) === value) {
...
var getCompatibleStyle2 = supportsAdoptingStyleSheets2 || NODE_MODE4 && global4.CSSStyleSheet === void 0 ? (s2) => s2 : (s2) => s2 instanceof CSSStyleSheet ? cssResultFromStyleSheet2(s2) : s2;
...
var ReactiveElement2 = class extends HTMLElement {
  ...
  static finalizeStyles(styles) {
    ...
    if (Array.isArray(styles)) {
      const set = new Set(styles.flat(Infinity).reverse());
      for (const s2 of set) {
        elementStyles2.unshift(getCompatibleStyle2(s2));
      }
    } else if (styles !== void 0) {
  ...
  __propertyToAttribute(name, value) {
    ...
    const attr = this.constructor.__attributeNameForProperty(name, options);
    if (attr !== void 0 && options.reflect === true) {
      const converter = ((_a8 = options.converter) == null ? void 0 : _a8.toAttribute) !== void 0 ? options.converter : defaultConverter2;
      const attrValue = converter.toAttribute(value, options.type);
  ...
  _$attributeToProperty(name, value) {
    ...
    if (propName !== void 0 && this.__reflectingProperty !== propName) {
      const options = ctor.getPropertyOptions(propName);
      const converter = typeof options.converter === "function" ? { fromAttribute: options.converter } : ((_a8 = options.converter) == null ? void 0 : _a8.fromAttribute) !== void 0 ? options.converter : defaultConverter2;
      this.__reflectingProperty = propName;
      this[propName] = converter.fromAttribute(
        value,
        options.type
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (DEV_MODE3) {
        const ctor = this.constructor;
        const shadowedProperties = [...ctor.elementProperties.keys()].filter((p3) => this.hasOwnProperty(p3) && p3 in getPrototypeOf2(this));
        if (shadowedProperties.length) {
          throw new Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${shadowedProperties.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`);
        }
      }
...
var tag2 = (type) => (strings, ...values) => {
  if (DEV_MODE4 && strings.some((s2) => s2 === void 0)) {
    console.warn("Some template strings are undefined.\nThis is probably caused by illegal octal escape sequences.");
  }
  if (DEV_MODE4) {
    if (values.some((val) => val == null ? void 0 : val["_$litStatic$"])) {
...
var getTemplateHtml2 = (strings, type) => {
  ...
  for (let i2 = 0; i2 < l2; i2++) {
    ...
    const end = regex === tagEndRegex2 && strings[i2 + 1].startsWith("/>") ? " " : "";
    html3 += regex === textEndRegex2 ? s2 + nodeMarker2 : attrNameEndIndex >= 0 ? (attrNames.push(attrName), s2.slice(0, attrNameEndIndex) + boundAttributeSuffix2 + s2.slice(attrNameEndIndex)) + marker2 + end : s2 + marker2 + (attrNameEndIndex === -2 ? i2 : end);
  }
  const htmlResult = html3 + (strings[l2] || "<?>") + (type === SVG_RESULT2 ? "</svg>" : "");
      ...
      if (node.nodeType === 1) {
          ...
          for (const name of node.getAttributeNames()) {
            if (name.endsWith(boundAttributeSuffix2)) {
              ...
              parts.push({
                ...
                name: m2[2],
                strings: statics,
                ctor: m2[1] === "." ? PropertyPart2 : m2[1] === "?" ? BooleanAttributePart2 : m2[1] === "@" ? EventPart2 : AttributePart2
              });
              node.removeAttribute(name);
        ...
        if (rawTextElement2.test(node.tagName)) {
          ...
          if (lastIndex > 0) {
            ...
            for (let i2 = 0; i2 < lastIndex; i2++) {
              node.append(strings2[i2], createMarker2());
              walker2.nextNode();
        ...
        if (data === markerMatch2) {
          ...
          let i2 = -1;
          while ((i2 = node.data.indexOf(marker2, i2 + 1)) !== -1) {
...
function resolveDirective2(part, value, parent2 = part, attributeIndex) {
  var _a8, _b4;
  if (value === noChange2) {
    return value;
  }
...
var AttributePart2 = class {
  ...
  _$setValue(value, directiveParent = this, valueIndex, noCommit) {
    ...
    if (strings === void 0) {
      ...
      let i2, v2;
      for (i2 = 0; i2 < strings.length - 1; i2++) {
        v2 = resolveDirective2(this, values[valueIndex + i2], directiveParent, i2);
        if (v2 === noChange2) {
          v2 = this._$committedValue[i2];
        }
        change || (change = !isPrimitive2(v2) || v2 !== this._$committedValue[i2]);
        if (v2 === nothing2) {
          value = nothing2;
...
function clone(configObject) {
    ...
    if (obj != null) {
      if (typeof obj == "object") {
        ...
        if (obj.hasOwnProperty(p3 = "FORMAT")) {
          ...
          else throw Error(bignumberError + p3 + " not an object: " + v2);
        }
  ...
  BigNumber2.random = function() {
    ...
    return function(dp) {
      var a2, b2, e, k2, v2, i2 = 0, c2 = [], rand = new BigNumber2(ONE);
  ...
  convertBase = /* @__PURE__ */ function() {
    ...
    return function(str, baseIn, baseOut, sign, callerIsToString) {
      var alphabet, d4, e, k2, r, x2, xc, y2, i2 = str.indexOf("."), dp = DECIMAL_PLACES, rm = ROUNDING_MODE;
      if (i2 >= 0) {
        k2 = POW_PRECISION;
        POW_PRECISION = 0;
        str = str.replace(".", "");
      ...
      i2 = xc[d4];
      k2 = baseOut / 2;
      r = r || d4 < 0 || xc[d4 + 1] != null;
      r = rm < 4 ? (i2 != null || r) && (rm == 0 || rm == (x2.s < 0 ? 3 : 2)) : i2 > k2 || i2 == k2 && (rm == 4 || r || rm == 6 && xc[d4 - 1] & 1 || rm == (x2.s < 0 ? 8 : 7));
      if (d4 < 1 || !xc[0]) {
  ...
  parseNumeric = /* @__PURE__ */ function() {
    ...
    return function(x2, str, isNum, b2) {
      ...
      if (isInfinityOrNaN.test(s2)) {
        ...
        if (!isNum) {
          s2 = s2.replace(basePrefix, function(m2, p1, p22) {
  ...
  function round(x2, sd, rm, r) {
    var d4, i2, j, k2, n2, ni, rd, xc = x2.c, pows10 = POWS_TEN;
    if (xc) {
      out: {
        ...
        if (i2 < 0) {
          ...
          j = sd;
          n2 = xc[ni = 0];
          rd = mathfloor(n2 / pows10[d4 - j - 1] % 10);
        } else {
        ...
        if (i2 == 0) {
          ...
          xc[ni] = j > 0 ? mathfloor(n2 / pows10[d4 - j] % pows10[j]) * k2 : 0;
        }
        if (r) {
          for (; ; ) {
            if (ni == 0) {
  ...
  P.minus = function(y2, b2) {
    var i2, j, t, xLTy, x2 = this, a2 = x2.s;
  ...
  P.toFraction = function(md) {
    var d4, d0, d1, d22, e, exp, n2, n0, n1, q, r, s2, x2 = this, xc = x2.c;
    if (md != null) {
    ...
    s2 = coeffToString(xc);
    e = d4.e = s2.length - x2.e - 1;
    d4.c[0] = POWS_TEN[(exp = e % LOG_BASE) < 0 ? LOG_BASE + exp : exp];
    md = !md || n2.comparedTo(d4) > 0 ? e > 0 ? d4 : n1 : n2;
    exp = MAX_EXP;
    MAX_EXP = 1 / 0;
...
function coeffToString(a2) {
  var s2, z3, i2 = 1, j = a2.length, r = a2[0] + "";
  for (; i2 < j; ) {
    s2 = a2[i2++] + "";
...
function compare(x2, y2) {
  var a2, b2, xc = x2.c, yc = y2.c, i2 = x2.s, j = y2.s, k2 = x2.e, l2 = y2.e;
  if (!i2 || !j) return null;
  a2 = xc && !xc[0];
  b2 = yc && !yc[0];
  if (a2 || b2) return a2 ? b2 ? 0 : -j : i2;
  if (i2 != j) return i2;
  a2 = i2 < 0;
  b2 = k2 == l2;
...
var NumberUtil = {
  ...
  multiply(a2, b2) {
    ...
    const bBigNumber = new bignumber_default(b2);
...
var __decorate = function(decorators, target, key, desc2) {
  var c2 = arguments.length, r = c2 < 3 ? target : desc2 === null ? desc2 = Object.getOwnPropertyDescriptor(target, key) : desc2, d4;
  if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc2);
  else for (var i2 = decorators.length - 1; i2 >= 0; i2--) if (d4 = decorators[i2]) r = (c2 < 3 ? d4(r) : c2 > 3 ? d4(target, key, r) : d4(target, key)) || r;
...
var notifyChildrenConnectedChanged = (parent2, isConnected) => {
  ...
  for (const obj of children) {
    (_a8 = obj["_$notifyDirectiveConnectionChanged"]) == null ? void 0 : _a8.call(obj, isConnected, false);
...
var AsyncDirective = class extends Directive {
  ...
  ["_$notifyDirectiveConnectionChanged"](isConnected, isClearingDirective = true) {
    ...
    if (isConnected !== this.isConnected) {
      ...
      if (isConnected) {
        (_a8 = this.reconnected) == null ? void 0 : _a8.call(this);
      } else {
...
var RefDirective = class extends AsyncDirective {
  ...
  update(part, [ref3]) {
    ...
    if (refChanged || this._lastElementForRef !== this._element) {
      this._ref = ref3;
      this._context = (_a8 = part.options) == null ? void 0 : _a8.host;
  ...
  get _lastElementForRef() {
    var _a8, _b4;
    return typeof this._ref === "function" ? (_a8 = lastElementForContextAndCallback.get(this._context ?? globalThis)) == null ? void 0 : _a8.get(this._ref) : (_b4 = this._ref) == null ? void 0 : _b4.value;
  }
  disconnected() {
...
var WuiInputText = class WuiInputText2 extends LitElement {
  ...
  dispatchInputChangeEvent() {
    ...
    this.dispatchEvent(new CustomEvent("inputChange", {
      detail: (_a8 = this.inputElementRef.value) == null ? void 0 : _a8.value,
      bubbles: true,
      composed: true
    }));
  }
...
var WuiTransactionListItem = class WuiTransactionListItem2 extends LitElement {
  ...
  templateDescription() {
    var _a8;
    const description = (_a8 = this.descriptions) == null ? void 0 : _a8[0];
  ...
  templateSecondDescription() {
    var _a8;
    const description = (_a8 = this.descriptions) == null ? void 0 : _a8[1];
    return description ? html2`
...
var WuiOtp = class WuiOtp2 extends LitElement {
  ...
  firstUpdated() {
    ...
    const numericElements = (_a8 = this.shadowRoot) == null ? void 0 : _a8.querySelectorAll("wui-input-numeric");
    if (numericElements) {
  ...
  render() {
    return html2`
      <wui-flex gap="xxs" data-testid="wui-otp-input">
        ${Array.from({ length: this.length }).map((_2, index) => html2`
            <wui-input-numeric
  ...
  getInputElement(el) {
    var _a8;
    if ((_a8 = el.shadowRoot) == null ? void 0 : _a8.querySelector("input")) {
  ...
  generate(uri, size, logoSize) {
    ...
    circles.forEach(([cx, cy]) => {
      ...
      if (circlesToConnect[cx]) {
        (_a8 = circlesToConnect[cx]) == null ? void 0 : _a8.push(cy);
      } else {
    ...
    return this.tabs.map((tab, index) => {
      ...
      return html2`
        <button
          ...
          data-testid="tab-${(_a8 = tab.label) == null ? void 0 : _a8.toLowerCase()}"
        >
...
var WuiTokenListItem = class WuiTokenListItem2 extends LitElement {
  ...
  render() {
    ...
    const value = this.amount && this.price ? (_a8 = NumberUtil.multiply(this.price, this.amount)) == null ? void 0 : _a8.toFixed(3) : null;
    return html2`
      <wui-flex alignItems="center">
        ${this.visualTemplate()}
        <wui-flex flexDirection="column" gap="3xs">
...
var WuiListAccordion = class WuiListAccordion2 extends LitElement {
  ...
  checkHeight() {
    this.updateComplete.then(() => {
      var _a8, _b4;
      const heightElement = (_a8 = this.shadowRoot) == null ? void 0 : _a8.querySelector(".heightContent");
  ...
  onClick() {
    var _a8;
    const icon = (_a8 = this.shadowRoot) == null ? void 0 : _a8.querySelector("wui-icon");
...
var CoreHelperUtil = {
  ...
  formatBalance(balance, symbol) {
    ...
    if (balance === "0") {
      ...
      if (number) {
        formattedBalance = (_a8 = number.toString().match(/^-?\d+(?:\.\d{0,3})?/u)) == null ? void 0 : _a8[0];
      }
    }
  ...
  parseError(error) {
    ...
    if (typeof error === "string") {
      return error;
    } else if (typeof ((_b4 = (_a8 = error == null ? void 0 : error.issues) == null ? void 0 : _a8[0]) == null ? void 0 : _b4.message) === "string") {
...
var ConnectorController = {
  ...
  addConnector(connector) {
    ...
    if (connector.id === "w3mAuth") {
      ...
      const themeVariables = ThemeController.getSnapshot().themeVariables;
      (_b4 = (_a8 = authConnector == null ? void 0 : authConnector.provider) == null ? void 0 : _a8.syncDappData) == null ? void 0 : _b4.call(_a8, {
  ...
  getAnnouncedConnectorRdns() {
    return state4.connectors.filter((c2) => c2.type === "ANNOUNCED").map((c2) => {
      var _a8;
      return (_a8 = c2.info) == null ? void 0 : _a8.rdns;
    });
  },
  getConnectors() {
  ...
  getConnector(id, rdns) {
    return state4.connectors.find((c2) => {
      var _a8;
      return c2.explorerId === id || ((_a8 = c2.info) == null ? void 0 : _a8.rdns) === rdns;
    });
  }
};
...
var NetworkController = {
  ...
  _getClient() {
    ...
    return state7._client;
  },
  setClient(client) {
    state7._client = ref(client);
  },
  setCaipNetwork(caipNetwork) {
    state7.caipNetwork = caipNetwork;
  ...
  setDefaultCaipNetwork(caipNetwork) {
    state7.caipNetwork = caipNetwork;
    PublicStateController.set({ selectedNetworkId: caipNetwork == null ? void 0 : caipNetwork.id });
    state7.isDefaultCaipNetwork = true;
  },
  setRequestedCaipNetworks(requestedNetworks) {
    state7.requestedCaipNetworks = requestedNetworks;
  },
  setAllowUnsupportedChain(allowUnsupportedChain) {
    state7.allowUnsupportedChain = allowUnsupportedChain;
  },
  setSmartAccountEnabledNetworks(smartAccountEnabledNetworks) {
    state7.smartAccountEnabledNetworks = smartAccountEnabledNetworks;
  },
  getRequestedCaipNetworks() {
    const { approvedCaipNetworkIds, requestedCaipNetworks } = state7;
  ...
  async getApprovedCaipNetworksData() {
    ...
    state7.supportsAllNetworks = data.supportsAllNetworks;
    state7.approvedCaipNetworkIds = data.approvedCaipNetworkIds;
  },
  async switchActiveNetwork(network) {
    await this._getClient().switchCaipNetwork(network);
    state7.caipNetwork = network;
    if (network) {
  ...
  checkIfSupportedNetwork() {
    var _a8;
    state7.isUnsupportedChain = !((_a8 = state7.requestedCaipNetworks) == null ? void 0 : _a8.some((network) => {
      var _a9;
      return network.id === ((_a9 = state7.caipNetwork) == null ? void 0 : _a9.id);
    }));
    if (state7.isUnsupportedChain) {
      this.showUnsupportedChainUI();
    }
  },
  checkIfSmartAccountEnabled() {
    var _a8, _b4;
    const networkId = NetworkUtil.caipNetworkIdToNumber((_a8 = state7.caipNetwork) == null ? void 0 : _a8.id);
    if (!networkId) {
      return false;
    }
    return Boolean((_b4 = state7.smartAccountEnabledNetworks) == null ? void 0 : _b4.includes(networkId));
  },
  resetNetwork() {
    if (!state7.isDefaultCaipNetwork) {
      state7.caipNetwork = void 0;
    }
    state7.approvedCaipNetworkIds = void 0;
    state7.supportsAllNetworks = true;
    state7.smartAccountEnabledNetworks = [];
  },
...
var ApiController = {
  ...
  async fetchRecommendedWallets() {
    ...
    const { data, count } = await api2.get({
      ...
      params: {
        page: "1",
        chains: (_a8 = NetworkController.state.caipNetwork) == null ? void 0 : _a8.id,
  ...
  async fetchWallets({ page }) {
    ...
    state8.wallets = CoreHelperUtil.uniqueBy([...state8.wallets, ...data], "id");
    ...
    if (data) {
      data.forEach((wallet) => {
        if (wallet == null ? void 0 : wallet.rdns) {
          state8.excludedRDNS.push(wallet.rdns);
        }
      });
    }
  },
  ...
  prefetch() {
    ...
    state8.prefetchPromise = Promise.race([Promise.allSettled(promises), CoreHelperUtil.wait(3e3)]);
  },
...
var OptionsController = {
  ...
  setProjectId(projectId) {
    state9.projectId = projectId;
  },
  setAllWallets(allWallets) {
    state9.allWallets = allWallets;
  },
  setIncludeWalletIds(includeWalletIds) {
    state9.includeWalletIds = includeWalletIds;
  },
  setExcludeWalletIds(excludeWalletIds) {
    state9.excludeWalletIds = excludeWalletIds;
    if (excludeWalletIds) {
      ApiController.searchWalletByIds({ ids: excludeWalletIds });
    }
  },
  setFeaturedWalletIds(featuredWalletIds) {
    state9.featuredWalletIds = featuredWalletIds;
  },
  setTokens(tokens) {
    state9.tokens = tokens;
  },
  setTermsConditionsUrl(termsConditionsUrl) {
    state9.termsConditionsUrl = termsConditionsUrl;
  },
  setPrivacyPolicyUrl(privacyPolicyUrl) {
    state9.privacyPolicyUrl = privacyPolicyUrl;
  },
  setCustomWallets(customWallets) {
    state9.customWallets = customWallets;
  },
  setIsSiweEnabled(isSiweEnabled) {
    state9.isSiweEnabled = isSiweEnabled;
  },
  setEnableAnalytics(enableAnalytics) {
    state9.enableAnalytics = enableAnalytics;
  },
  setSdkVersion(sdkVersion) {
    state9.sdkVersion = sdkVersion;
  },
  setMetadata(metadata) {
    state9.metadata = metadata;
  },
  setOnrampEnabled(enableOnramp) {
    state9.enableOnramp = enableOnramp;
  },
  setDisableAppend(disableAppend) {
    state9.disableAppend = disableAppend;
  },
  getSnapshot() {
...
var SnackController = {
  ...
  showLoading(message) {
    ...
    state10.variant = "loading";
    state10.open = true;
  },
  showSuccess(message) {
    state10.message = message;
    state10.variant = "success";
    state10.open = true;
  },
  showError(message) {
    const errorMessage = CoreHelperUtil.parseError(message);
    state10.message = errorMessage;
    state10.variant = "error";
    state10.open = true;
  },
  hide() {
    state10.open = false;
...
if (typeof window !== "undefined") {
  ...
  if (!((_a7 = window.process) == null ? void 0 : _a7.env)) {
    window.process = { env: {} };
  }
}
...
var ZodType = class {
  ...
  safeParse(data, params) {
    ...
    const ctx = {
      common: {
        issues: [],
        async: (_a8 = params === null || params === void 0 ? void 0 : params.async) !== null && _a8 !== void 0 ? _a8 : false,
...
var ZodString = class _ZodString extends ZodType {
  ...
  datetime(options) {
    ...
    return this._addCheck({
      ...
      offset: (_a8 = options === null || options === void 0 ? void 0 : options.offset) !== null && _a8 !== void 0 ? _a8 : false,
...
ZodString.create = (params) => {
  ...
  return new ZodString({
    ...
    coerce: (_a8 = params === null || params === void 0 ? void 0 : params.coerce) !== null && _a8 !== void 0 ? _a8 : false,
  ...
  strict(message) {
    ...
    return new _ZodObject({
      ...
      ...message !== void 0 ? {
        errorMap: (issue, ctx) => {
          var _a8, _b4, _c, _d;
          const defaultError = (_c = (_b4 = (_a8 = this._def).errorMap) === null || _b4 === void 0 ? void 0 : _b4.call(_a8, issue, ctx).message) !== null && _c !== void 0 ? _c : ctx.defaultError;
  ...
  if (check)
    return ZodAny.create().superRefine((data, ctx) => {
      ...
      if (!check(data)) {
        ...
        const _fatal = (_b4 = (_a8 = p3.fatal) !== null && _a8 !== void 0 ? _a8 : fatal) !== null && _b4 !== void 0 ? _b4 : true;
...
var W3mFrameHelpers = {
  ...
  getRequestMethod(request) {
    var _a8;
    return (_a8 = request == null ? void 0 : request.payload) == null ? void 0 : _a8.method;
  },
...
var L = class {
  constructor(e, t = l) {
    this.level = e ?? "error", this.levelValue = import_pino.levels.values[this.level], this.MAX_LOG_SIZE_IN_BYTES = t, this.logs = new d3(this.MAX_LOG_SIZE_IN_BYTES);
  }
...
var TransactionsController = {
  ...
  async fetchTransactions(accountAddress, onramp) {
    ...
    try {
      ...
      const filteredTransactions = [...state11.transactions, ...nonSpamTransactions];
      ...
      if (onramp === "coinbase") {
        ...
        state11.transactionsByYear = this.groupTransactionsByYearAndMonth(state11.transactionsByYear, nonSpamTransactions);
      }
  ...
  filterSpamTransactions(transactions) {
    return transactions.filter((transaction) => {
      const isAllSpam = transaction.transfers.every((transfer) => {
        var _a8;
        return ((_a8 = transfer.nft_info) == null ? void 0 : _a8.flags.is_spam) === true;
      });
      return !isAllSpam;
    });
  },
...
var ConnectionController = {
  ...
  async connectExternal(options) {
    var _a8, _b4;
    await ((_b4 = (_a8 = this._getClient()).connectExternal) == null ? void 0 : _b4.call(_a8, options));
    StorageUtil.setConnectedConnector(options.type);
  },
  async reconnectExternal(options) {
    var _a8, _b4;
    await ((_b4 = (_a8 = this._getClient()).reconnectExternal) == null ? void 0 : _b4.call(_a8, options));
    StorageUtil.setConnectedConnector(options.type);
  },
  async setPreferredAccountType(accountType) {
    ...
    EventsController.sendEvent({
      ...
      properties: { accountType, network: ((_a8 = NetworkController.state.caipNetwork) == null ? void 0 : _a8.id) || "" }
    });
  },
  ...
  checkInstalled(ids) {
    var _a8, _b4;
    return (_b4 = (_a8 = this._getClient()).checkInstalled) == null ? void 0 : _b4.call(_a8, ids);
  },
  resetWcConnection() {
...
var SwapApiUtil = {
  async getTokenList() {
    ...
    const response = await BlockchainApiController.fetchSwapTokens({
      chainId: (_a8 = NetworkController.state.caipNetwork) == null ? void 0 : _a8.id,
      projectId: OptionsController.state.projectId
    });
    const tokens = ((_b4 = response == null ? void 0 : response.tokens) == null ? void 0 : _b4.map((token) => ({
      ...token,
      eip2612: false,
      quantity: {
        decimals: "0",
...
var RouterController = {
  ...
  popTransactionStack(cancel) {
    ...
    if (cancel) {
      this.goBack();
      (_a8 = action == null ? void 0 : action.onCancel) == null ? void 0 : _a8.call(action);
    } else {
      if (action.goBack) {
        this.goBack();
      } else if (action.view) {
      ...
      (_b4 = action == null ? void 0 : action.onSuccess) == null ? void 0 : _b4.call(action);
    }
  },
  push(view, data) {
  ...
  replace(view, data) {
    if (state13.history.length >= 1 && state13.history.at(-1) !== view) {
      state13.view = view;
...
var SwapCalculationUtil = {
  ...
  isInsufficientSourceTokenForSwap(sourceTokenAmount, sourceTokenAddress, balance) {
    var _a8, _b4;
    const sourceTokenBalance = (_b4 = (_a8 = balance == null ? void 0 : balance.find((token) => token.address === sourceTokenAddress)) == null ? void 0 : _a8.quantity) == null ? void 0 : _b4.numeric;
...
var state14 = proxy(initialState);
var SwapController = {
  state: state14,
  subscribe(callback) {
  ...
  getParams() {
    var _a8, _b4, _c, _d, _e, _f, _g, _h, _i;
    const { address } = AccountController.state;
    const networkAddress = `${(_a8 = NetworkController.state.caipNetwork) == null ? void 0 : _a8.id}:${ConstantsUtil2.NATIVE_TOKEN_ADDRESS}`;
    if (!address) {
      throw new Error("No address found to swap the tokens from.");
    }
    const caipAddress = AccountController.state.caipAddress;
    const invalidToToken = !((_b4 = state14.toToken) == null ? void 0 : _b4.address) || !((_c = state14.toToken) == null ? void 0 : _c.decimals);
    const invalidSourceToken = !((_d = state14.sourceToken) == null ? void 0 : _d.address) || !((_e = state14.sourceToken) == null ? void 0 : _e.decimals) || !NumberUtil.bigNumber(state14.sourceTokenAmount).isGreaterThan(0);
    const invalidSourceTokenAmount = !state14.sourceTokenAmount;
    return {
      networkAddress,
      fromAddress: address,
      fromCaipAddress: AccountController.state.caipAddress,
      sourceTokenAddress: (_f = state14.sourceToken) == null ? void 0 : _f.address,
      toTokenAddress: (_g = state14.toToken) == null ? void 0 : _g.address,
      toTokenAmount: state14.toTokenAmount,
      toTokenDecimals: (_h = state14.toToken) == null ? void 0 : _h.decimals,
      sourceTokenAmount: state14.sourceTokenAmount,
      sourceTokenDecimals: (_i = state14.sourceToken) == null ? void 0 : _i.decimals,
      invalidToToken,
      invalidSourceToken,
  ...
  setSourceToken(sourceToken) {
    if (!sourceToken) {
      state14.sourceToken = sourceToken;
      state14.sourceTokenAmount = "";
      state14.sourceTokenPriceInUSD = 0;
      return;
    }
    state14.sourceToken = sourceToken;
  ...
  setSourceTokenAmount(amount) {
    state14.sourceTokenAmount = amount;
  },
  setToToken(toToken) {
    if (!toToken) {
      state14.toToken = toToken;
      state14.toTokenAmount = "";
      state14.toTokenPriceInUSD = 0;
      return;
    }
    state14.toToken = toToken;
  ...
  setToTokenAmount(amount) {
    state14.toTokenAmount = amount ? NumberUtil.formatNumberToLocalString(amount, TO_AMOUNT_DECIMALS) : "";
  },
  async setTokenPrice(address, target) {
    const { availableToSwap } = this.getParams();
    let price = state14.tokensPriceMap[address] || 0;
    if (!price) {
      state14.loadingPrices = true;
      price = await this.getAddressPrice(address);
    }
    if (target === "sourceToken") {
      state14.sourceTokenPriceInUSD = price;
    } else if (target === "toToken") {
      state14.toTokenPriceInUSD = price;
    }
    if (state14.loadingPrices) {
      state14.loadingPrices = false;
      if (availableToSwap) {
        this.swapTokens();
      }
    }
  ...
  switchTokens() {
    if (state14.initializing || !state14.initialized) {
      return;
    }
    const newSourceToken = state14.toToken ? { ...state14.toToken } : void 0;
    const newToToken = state14.sourceToken ? { ...state14.sourceToken } : void 0;
    const newSourceTokenAmount = newSourceToken && state14.toTokenAmount === "" ? "1" : state14.toTokenAmount;
  ...
  resetState() {
    state14.myTokensWithBalance = initialState.myTokensWithBalance;
    state14.tokensPriceMap = initialState.tokensPriceMap;
    state14.initialized = initialState.initialized;
    state14.sourceToken = initialState.sourceToken;
    state14.sourceTokenAmount = initialState.sourceTokenAmount;
    state14.sourceTokenPriceInUSD = initialState.sourceTokenPriceInUSD;
    state14.toToken = initialState.toToken;
    state14.toTokenAmount = initialState.toTokenAmount;
    state14.toTokenPriceInUSD = initialState.toTokenPriceInUSD;
    state14.networkPrice = initialState.networkPrice;
    state14.networkTokenSymbol = initialState.networkTokenSymbol;
    state14.networkBalanceInUSD = initialState.networkBalanceInUSD;
    state14.inputError = initialState.inputError;
  },
  resetValues() {
    var _a8;
    const { networkAddress } = this.getParams();
    const networkToken = (_a8 = state14.tokens) == null ? void 0 : _a8.find((token) => token.address === networkAddress);
    this.setSourceToken(networkToken);
    this.setToToken(void 0);
  },
  getApprovalLoadingState() {
    return state14.loadingApprovalTransaction;
  },
  clearError() {
    state14.transactionError = void 0;
  },
  async initializeState() {
    if (state14.initializing) {
      return;
    }
    state14.initializing = true;
    if (!state14.initialized) {
      try {
        await this.fetchTokens();
        state14.initialized = true;
      } catch (error) {
        state14.initialized = false;
        SnackController.showError("Failed to initialize swap");
        RouterController.goBack();
      }
    }
    state14.initializing = false;
  },
  async fetchTokens() {
    var _a8;
    const { networkAddress } = this.getParams();
    ...
    const networkToken = (_a8 = state14.tokens) == null ? void 0 : _a8.find((token) => token.address === networkAddress);
    if (networkToken) {
      state14.networkTokenSymbol = networkToken.symbol;
      this.setSourceToken(networkToken);
  ...
  async getTokenList() {
    ...
    state14.popularTokens = tokens.sort((aTokenInfo, bTokenInfo) => {
    ...
    state14.suggestedTokens = tokens.filter((token) => {
  ...
  async getAddressPrice(address) {
    var _a8, _b4;
    const existPrice = state14.tokensPriceMap[address];
    if (existPrice) {
      return existPrice;
    }
    ...
    const allTokens = [...state14.tokens || [], ...state14.myTokensWithBalance || []];
    const symbol = (_a8 = allTokens == null ? void 0 : allTokens.find((token) => token.address === address)) == null ? void 0 : _a8.symbol;
    const price = ((_b4 = fungibles.find((p3) => p3.symbol.toLowerCase() === (symbol == null ? void 0 : symbol.toLowerCase()))) == null ? void 0 : _b4.price) || 0;
    const priceAsFloat = parseFloat(price.toString());
    state14.tokensPriceMap[address] = priceAsFloat;
    return priceAsFloat;
  },
  async getNetworkTokenPrice() {
    ...
    const token = (_a8 = response.fungibles) == null ? void 0 : _a8[0];
    const price = (token == null ? void 0 : token.price.toString()) || "0";
    state14.tokensPriceMap[networkAddress] = parseFloat(price);
    state14.networkTokenSymbol = (token == null ? void 0 : token.symbol) || "";
    state14.networkPrice = price;
  },
  async getMyTokensWithBalance(forceUpdate) {
  ...
  setBalances(balances) {
    ...
    balances.forEach((token) => {
      state14.tokensPriceMap[token.address] = token.price || 0;
    });
    state14.myTokensWithBalance = balances.filter((token) => token.address.startsWith(caipNetwork.id));
    state14.networkBalanceInUSD = networkToken ? NumberUtil.multiply(networkToken.quantity.numeric, networkToken.price).toString() : "0";
  },
  async getInitialGasPrice() {
    ...
    const gasPrice = SwapCalculationUtil.getGasPriceInUSD(state14.networkPrice, gasLimit, gasFee);
    state14.gasFee = value;
    state14.gasPriceInUSD = gasPrice;
    return { gasPrice: gasFee, gasPriceInUSD: state14.gasPriceInUSD };
  },
  async swapTokens() {
    var _a8, _b4;
    const address = AccountController.state.address;
    const sourceToken = state14.sourceToken;
    const toToken = state14.toToken;
    const haveSourceTokenAmount = NumberUtil.bigNumber(state14.sourceTokenAmount).isGreaterThan(0);
    if (!toToken || !sourceToken || state14.loadingPrices || !haveSourceTokenAmount) {
      return;
    }
    state14.loadingQuote = true;
    const amountDecimal = NumberUtil.bigNumber(state14.sourceTokenAmount).multipliedBy(10 ** sourceToken.decimals);
    const quoteResponse = await BlockchainApiController.fetchSwapQuote({
      userAddress: address,
      projectId: OptionsController.state.projectId,
      from: sourceToken.address,
      to: toToken.address,
      gasPrice: state14.gasFee,
      amount: amountDecimal.toString()
    });
    state14.loadingQuote = false;
    const quoteToAmount = (_b4 = (_a8 = quoteResponse == null ? void 0 : quoteResponse.quotes) == null ? void 0 : _a8[0]) == null ? void 0 : _b4.toAmount;
    if (!quoteToAmount) {
      return;
    }
    const toTokenAmount = NumberUtil.bigNumber(quoteToAmount).dividedBy(10 ** toToken.decimals).toString();
    this.setToTokenAmount(toTokenAmount);
    const isInsufficientToken = this.hasInsufficientToken(state14.sourceTokenAmount, sourceToken.address);
    if (isInsufficientToken) {
      state14.inputError = "Insufficient balance";
    } else {
      state14.inputError = void 0;
  ...
  async getTransaction() {
    ...
    const sourceToken = state14.sourceToken;
    const toToken = state14.toToken;
    if (!fromCaipAddress || !availableToSwap || !sourceToken || !toToken || state14.loadingQuote) {
      return void 0;
    }
    try {
      state14.loadingBuildTransaction = true;
      ...
      state14.loadingBuildTransaction = false;
      state14.fetchError = false;
      return transaction;
    } catch (error) {
      RouterController.goBack();
      SnackController.showError("Failed to check allowance");
      state14.loadingBuildTransaction = false;
      state14.approvalTransaction = void 0;
      state14.swapTransaction = void 0;
      state14.fetchError = true;
      return void 0;
    }
  },
  async createAllowanceTransaction() {
    ...
    try {
      ...
      const transaction = {
        ...
        toAmount: state14.toTokenAmount
      };
      state14.swapTransaction = void 0;
      state14.approvalTransaction = transaction;
      return transaction;
    } catch (error) {
      RouterController.goBack();
  ...
  async createSwapTransaction() {
    ...
    try {
      ...
      state14.gasPriceInUSD = SwapCalculationUtil.getGasPriceInUSD(state14.networkPrice, gas, gasPrice);
      state14.approvalTransaction = void 0;
      state14.swapTransaction = transaction;
      return transaction;
    } catch (error) {
      RouterController.goBack();
  ...
  async sendTransactionForApproval(data) {
    ...
    state14.loadingApprovalTransaction = true;
    ...
    try {
      ...
      state14.approvalTransaction = void 0;
      state14.loadingApprovalTransaction = false;
    } catch (err) {
      const error = err;
      state14.transactionError = error == null ? void 0 : error.shortMessage;
      state14.loadingTransaction = false;
    }
  },
  async sendTransactionForSwap(data) {
    var _a8, _b4, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l;
    if (!data) {
      return void 0;
    }
    const { fromAddress, toTokenAmount } = this.getParams();
    state14.loadingTransaction = true;
    const snackbarPendingMessage = `Swapping ${(_a8 = state14.sourceToken) == null ? void 0 : _a8.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_b4 = state14.toToken) == null ? void 0 : _b4.symbol}`;
    const snackbarSuccessMessage = `Swapped ${(_c = state14.sourceToken) == null ? void 0 : _c.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_d = state14.toToken) == null ? void 0 : _d.symbol}`;
    RouterController.pushTransactionStack({
      view: "Account",
      goBack: false,
      onSuccess() {
    ...
    try {
      const forceUpdateAddresses = [(_e = state14.sourceToken) == null ? void 0 : _e.address, (_f = state14.toToken) == null ? void 0 : _f.address].join(",");
  ...
  hasInsufficientToken(sourceTokenAmount, sourceTokenAddress) {
    const isInsufficientSourceTokenForSwap = SwapCalculationUtil.isInsufficientSourceTokenForSwap(sourceTokenAmount, sourceTokenAddress, state14.myTokensWithBalance);
    const insufficientNetworkTokenForGas = SwapCalculationUtil.isInsufficientNetworkTokenForGas(state14.networkBalanceInUSD, state14.gasPriceInUSD);
  ...
  setTransactionDetails() {
    ...
    state14.gasPriceInUSD = SwapCalculationUtil.getGasPriceInUSD(state14.networkPrice, BigInt(state14.gasFee), BigInt(INITIAL_GAS_LIMIT));
    state14.priceImpact = SwapCalculationUtil.getPriceImpact({
      sourceTokenAmount: state14.sourceTokenAmount,
      sourceTokenPriceInUSD: state14.sourceTokenPriceInUSD,
      toTokenPriceInUSD: state14.toTokenPriceInUSD,
      toTokenAmount: state14.toTokenAmount
    });
    state14.maxSlippage = SwapCalculationUtil.getMaxSlippage(state14.slippage, state14.toTokenAmount);
    state14.providerFee = SwapCalculationUtil.getProviderFee(state14.sourceTokenAmount);
  }
};
...
var AccountController = {
  ...
  setIsConnected(isConnected) {
    state15.isConnected = isConnected;
  },
  setCaipAddress(caipAddress) {
    state15.caipAddress = caipAddress;
    state15.address = caipAddress ? CoreHelperUtil.getPlainAddress(caipAddress) : void 0;
  },
  setBalance(balance, balanceSymbol) {
    state15.balance = balance;
    state15.balanceSymbol = balanceSymbol;
  },
  setProfileName(profileName) {
    state15.profileName = profileName;
  },
  setProfileImage(profileImage) {
    state15.profileImage = profileImage;
  },
  setAddressExplorerUrl(explorerUrl) {
    state15.addressExplorerUrl = explorerUrl;
  },
  setSmartAccountDeployed(isDeployed) {
    state15.smartAccountDeployed = isDeployed;
  },
  setCurrentTab(currentTab) {
    state15.currentTab = currentTab;
  },
  setTokenBalance(tokenBalance) {
    if (tokenBalance) {
      state15.tokenBalance = ref(tokenBalance);
    }
  },
  setConnectedWalletInfo(connectedWalletInfo) {
    state15.connectedWalletInfo = connectedWalletInfo;
  },
  setPreferredAccountType(preferredAccountType) {
    state15.preferredAccountType = preferredAccountType;
  },
  setSocialProvider(socialProvider) {
    if (socialProvider) {
      state15.socialProvider = socialProvider;
    }
  },
  setSocialWindow(socialWindow) {
    if (socialWindow) {
      state15.socialWindow = ref(socialWindow);
    }
  },
  async fetchTokenBalance() {
    var _a8;
    const chainId = (_a8 = NetworkController.state.caipNetwork) == null ? void 0 : _a8.id;
    try {
      if (state15.address && chainId) {
        const response = await BlockchainApiController.getBalance(state15.address, chainId);
  ...
  resetAccount() {
    state15.isConnected = false;
    state15.smartAccountDeployed = false;
    state15.currentTab = 0;
    state15.caipAddress = void 0;
    state15.address = void 0;
    state15.balance = void 0;
    state15.balanceSymbol = void 0;
    state15.profileName = void 0;
    state15.profileImage = void 0;
    state15.addressExplorerUrl = void 0;
    state15.tokenBalance = [];
    state15.connectedWalletInfo = void 0;
    state15.preferredAccountType = void 0;
    state15.socialProvider = void 0;
    state15.socialWindow = void 0;
  }
};
  ...
  async getQuote() {
    ...
    try {
      const quote = await BlockchainApiController.getOnrampQuote({
        ...
        amount: ((_a8 = state17.paymentAmount) == null ? void 0 : _a8.toString()) || "0",
        network: (_b4 = state17.purchaseCurrency) == null ? void 0 : _b4.symbol
      });
...
var SendController = {
  ...
  sendToken() {
    var _a8, _b4, _c, _d, _e;
    if (((_a8 = this.state.token) == null ? void 0 : _a8.address) && this.state.sendTokenAmount && this.state.receiverAddress) {
      EventsController.sendEvent({
        type: "track",
        ...
        properties: {
          ...
          network: ((_b4 = NetworkController.state.caipNetwork) == null ? void 0 : _b4.id) || ""
        }
      });
      this.sendERC20Token({
  ...
  async sendNativeToken(params) {
    ...
    try {
      ...
      EventsController.sendEvent({
        ...
        properties: {
          isSmartAccount: AccountController.state.preferredAccountType === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT,
          token: ((_a8 = this.state.token) == null ? void 0 : _a8.symbol) || "",
...
var EnsController = {
  ...
  async resolveName(name) {
    ...
    try {
      ...
      const error = e;
      throw new Error(((_b4 = (_a8 = error == null ? void 0 : error.reasons) == null ? void 0 : _a8[0]) == null ? void 0 : _b4.description) || "Error resolving name");
    }
  },
  ...
  parseEnsApiError(error, defaultError) {
    ...
    return ((_b4 = (_a8 = ensError == null ? void 0 : ensError.reasons) == null ? void 0 : _a8[0]) == null ? void 0 : _b4.description) || defaultError;
  }
};
...
var WuiOnRampActivityItem = class WuiOnRampActivityItem2 extends LitElement {
  ...
  render() {
    return html2`
      <wui-flex>
        ...
        ${this.inProgress ? html2`<wui-loading-spinner color="fg-200" size="md"></wui-loading-spinner>` : html2`<wui-text variant="micro-700" color="fg-300"><span>${this.date}</span></wui-text>`}
      </wui-flex>
    `;
  }
  ...
  imageTemplate() {
    ...
    return html2`<wui-flex class="purchase-image-container">
  ...
  render() {
    return html2`
      <button ?disabled=${this.disabled} ontouchstart>
        ...
        ${this.loading ? html2`<wui-loading-spinner color="fg-200" size="md"></wui-loading-spinner>` : html2`<wui-icon name="chevronRight" color="fg-200" size="sm"></wui-icon>`}
      </button>
    `;
  }
  networksTemplate() {
    ...
    const slicedNetworks = (_a8 = networks == null ? void 0 : networks.filter((network) => network == null ? void 0 : network.imageId)) == null ? void 0 : _a8.slice(0, 5);
    return html2`
      <wui-flex class="networks">
        ${slicedNetworks == null ? void 0 : slicedNetworks.map((network) => html2`
...
var WuiInputAmount = class WuiInputAmount2 extends LitElement {
  ...
  render() {
    var _a8;
    if (((_a8 = this.inputElementRef) == null ? void 0 : _a8.value) && this.value) {
  ...
  dispatchInputChangeEvent(e) {
    ...
    if (inputChar && ((_a8 = this.inputElementRef) == null ? void 0 : _a8.value)) {
      if (inputChar === ",") {
...
var TransactionUtil = {
  ...
  getTransactionImageURL(transfer) {
    ...
    if (transfer && isNFT) {
      imageURL = (_c = (_b4 = (_a8 = transfer == null ? void 0 : transfer.nft_info) == null ? void 0 : _a8.content) == null ? void 0 : _b4.preview) == null ? void 0 : _c.url;
  ...
  getTransactionDescriptions(transaction) {
    var _a8, _b4, _c;
    const type = (_a8 = transaction == null ? void 0 : transaction.metadata) == null ? void 0 : _a8.operationType;
  ...
  getTransferDescription(transfer) {
    ...
    if (transfer == null ? void 0 : transfer.nft_info) {
      description = ((_a8 = transfer == null ? void 0 : transfer.nft_info) == null ? void 0 : _a8.name) || "-";
  ...
  getFungibleTransferDescription(transfer) {
    ...
    const description = [quantity, (_a8 = transfer == null ? void 0 : transfer.fungible_info) == null ? void 0 : _a8.symbol].join(" ").trim();
    return description;
  },
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-RVECJYGR.js.map
