...
import walletIcon from "/images/digital-wallet.png"; // Make sure to add the wallet icon to your project
...
const FastSwapComponent = () => {
        ...
        const wasAdded = await window.ethereum.request({
          ...
          params: {
            ...
            options: {
              ...
              symbol: 'PURP', // Token Symbol
              decimals: 18, // Token Decimals
              image: tokenLogoUrl, // Token Image URL
            },
          },
        });
  ...
  return (
    ...
    <img src="images/friends.png" alt="DegenSwap Logo" style={{ align: 'center', width: '370px',   }} />
